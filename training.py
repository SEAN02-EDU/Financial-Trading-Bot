...
# --------------------------------------------------
file_path = r"C:\Users\User\Downloads\DIA-2425-20398907(FTB)\AMZN_Significant.csv"
...
selected_features = ['Close', 'Daily_ROI', 'ATR','MACD','ADX','Revenue_Growth','Gross_Margin','sentiment_score']
...
# --------------------------------------------------
callbacks = [
    EarlyStopping(monitor='val_loss', min_delta=1e-10, patience=1, verbose=1),
